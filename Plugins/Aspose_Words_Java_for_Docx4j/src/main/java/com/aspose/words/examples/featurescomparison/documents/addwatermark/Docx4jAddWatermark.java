package com.aspose.words.examples.featurescomparison.documents.addwatermark;
 ...
 * @author jharrop
 */
public class Docx4jAddWatermark
{
    // The path to the documents directory.
    static String dataDir = Utils.getDataDir(Docx4jAddWatermark.class);
