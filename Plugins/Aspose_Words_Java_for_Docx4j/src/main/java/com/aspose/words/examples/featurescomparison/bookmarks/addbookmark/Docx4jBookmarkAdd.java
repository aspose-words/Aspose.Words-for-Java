...
package com.aspose.words.examples.featurescomparison.bookmarks.addbookmark;
...
public class Docx4jBookmarkAdd  extends AbstractSample 
{
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        String dataDir = Utils.getDataDir(Docx4jBookmarkAdd.class);
