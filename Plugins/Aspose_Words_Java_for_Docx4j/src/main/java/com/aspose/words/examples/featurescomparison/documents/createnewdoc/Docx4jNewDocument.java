...
package com.aspose.words.examples.featurescomparison.documents.createnewdoc;
 ...
 * @author Jason Harrop
 */
public class Docx4jNewDocument extends AbstractSample {
    public static void main(String[] args) throws Exception 
    {		
        // The path to the documents directory.
        String dataDir = Utils.getDataDir(Docx4jNewDocument.class);
        ...
        // Optionally save it
        if (save) {
            String filename = dataDir + "OUT_CreateWordprocessingMLDocument.docx";
