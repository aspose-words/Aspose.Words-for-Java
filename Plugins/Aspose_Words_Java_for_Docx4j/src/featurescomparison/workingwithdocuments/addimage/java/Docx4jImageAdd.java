...
package featurescomparison.workingwithdocuments.addimage.java;
 ...
 * @author Jason Harrop
 */
public class Docx4jImageAdd {

	public static void main(String[] args) throws Exception {
		
		String dataPath = "src/featurescomparison/workingwithdocuments/addimage/data/";
