 ...
 *
 */
public class Docx4jTableOfContents 
{
	static String dataPath = "src/featurescomparison/workingwithdocuments/inserttableofcontents/data/";
	...
	public static void main(String[] args) throws Exception {
		...
		wordMLPackage.save(new java.io.File(dataPath + "OUT_TableOfContentsAdd.docx") );
