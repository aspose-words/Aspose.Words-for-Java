 ...
 *
 */
public class Docx4jHeaderCreate {

	private static ObjectFactory objectFactory = new ObjectFactory();
	static String dataPath = "src/featurescomparison/workingwithheaderfooter/addheader/data/";
	...
	public static void main(String[] args) throws Exception {
		...
		// Now save it 
		wordMLPackage.save(new java.io.File(dataPath + "OUT_Header.docx") );
