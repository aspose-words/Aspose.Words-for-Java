...
public class ExDotNetVsJava
{
    ...
    void save(String fileName, int saveFormat) throws Exception
    //ExEnd
    {
        // Do nothing.
    }
    ...
    public class HeaderFooterCollection
    {
        ...
        public HeaderFooter get(int index) throws Exception                 //ExSkip
        {                   //ExSkip
            return null;    //ExSkip
        }                       //ExSkip

        // Get by header footer type is an overloaded indexer.
        public HeaderFooter getByHeaderFooterType(int headerFooterType) throws Exception                 //ExSkip
        {                   //ExSkip
            return null;    //ExSkip
        }                       //ExSkip
    }
