...
public class ExLists extends ExBase
{
    ...
    public void nestedLists() throws Exception
    {
        ...
        builder.getDocument().save(getMyDir() + "Lists.NestedLists Out.doc");
        //ExEnd
    }
    ...
    public void removeBulletsFromParagraphs() throws Exception
    {
        ...
        for (Paragraph paragraph : (Iterable<Paragraph>) body.getParagraphs())
    ...
    public void outlineHeadingTemplates() throws Exception
    {
        ...
        builder.getDocument().save(getMyDir() + "Lists.OutlineHeadingTemplates Out.doc");
    }
    ...
    public void listDocument() throws Exception
    {
        ...
        System.out.println("List count: " + lists.getCount());
