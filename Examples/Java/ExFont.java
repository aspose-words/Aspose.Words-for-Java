...
public class ExFont extends ExBase
{
    @Test
    ...
    //ExFor:DocumentVisitor.VisitDrawingML(Aspose.Words.Drawing.DrawingML)
    ...
    private class RemoveHiddenContentVisitor extends DocumentVisitor
    {
        ...
        /**
         * Called when a DrawingML is encountered in the document.
         */
        public int visitDrawingML(DrawingML drawingML) throws Exception
        {
            if (isHidden(drawingML))
                drawingML.remove();
