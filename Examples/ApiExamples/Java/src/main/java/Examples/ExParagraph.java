...
public class ExParagraph extends ApiExampleBase {
    ...
    public void documentBuilderInsertParagraph() throws Exception {
        ...
        Assert.assertEquals(8.0d, paragraph.getParagraphFormat().getFirstLineIndent());
    ...
    /// </summary>
    private static void insertFieldUsingFieldType(Document doc, int fieldType, boolean updateField, Node refNode,
