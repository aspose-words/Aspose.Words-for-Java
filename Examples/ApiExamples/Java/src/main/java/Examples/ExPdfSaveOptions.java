...
public class ExPdfSaveOptions extends ApiExampleBase {
    ...
    public void openHyperlinksInNewWindow(boolean openHyperlinksInNewWindow) throws Exception {
        ...
        if (openHyperlinksInNewWindow)
            TestUtil.fileContainsString(
                "<</Type/Annot/Subtype/Link/Rect[72 706.20098877 111.32800293 720]/BS" +
    ...
    public void headerFooterBookmarksExportMode(final int headerFooterBookmarksExportMode) throws Exception {
        ...
        switch (headerFooterBookmarksExportMode) {
            case com.aspose.words.HeaderFooterBookmarksExportMode.NONE:
                TestUtil.fileContainsString(MessageFormat.format("<</Type/Catalog/Pages 3 0 R/Lang({0})/Metadata 4 0 R>>\r\n", inputDocLocaleName),
            ...
            case com.aspose.words.HeaderFooterBookmarksExportMode.ALL:
                TestUtil.fileContainsString(
                        MessageFormat.format("<</Type/Catalog/Pages 3 0 R/Outlines 15 0 R/PageMode/UseOutlines/Lang({0})/Metadata 4 0 R>>", inputDocLocaleName),
                        getArtifactsDir() + "PdfSaveOptions.HeaderFooterBookmarksExportMode.pdf");
    ...
    public void embedFullFonts(boolean embedFullFonts) throws Exception {
        ...
        if (embedFullFonts)
            Assert.assertTrue(new File(getArtifactsDir() + "PdfSaveOptions.EmbedFullFonts.pdf").length() < 592500);
        else
    ...
    public void additionalTextPositioning(boolean applyAdditionalTextPositioning) throws Exception {
        ...
        if (applyAdditionalTextPositioning) {
            Assert.assertTrue(new File(getArtifactsDir() + "PdfSaveOptions.AdditionalTextPositioning.pdf").length() < 102800);
            Assert.assertEquals(
                    "[0 (S) 0 (a) 0 (m) 0 (s) 0 (t) 0 (a) -1 (g) 1 (,) 0 ( ) 0 (1) 0 (0) 0 (.) 0 ( ) 0 (N) 0 (o) 0 (v) 0 (e) 0 (m) 0 (b) 0 (e) 0 (r) -1 ( ) 1 (2) -1 (0) 0 (1) 0 (8)] TJ",
                    tjOperator.toString());
        } else {
            Assert.assertTrue(new File(getArtifactsDir() + "PdfSaveOptions.AdditionalTextPositioning.pdf").length() < 99960);
    ...
    public void pageMode(int pageMode) throws Exception {
        ...
        switch (pageMode) {
            case PdfPageMode.FULL_SCREEN:
                TestUtil.fileContainsString(
                        MessageFormat.format("<</Type/Catalog/Pages 3 0 R/PageMode/FullScreen/Lang({0})/Metadata 4 0 R>>\r\n", docLocaleName),
                        getArtifactsDir() + "PdfSaveOptions.PageMode.pdf");
                break;
            case PdfPageMode.USE_THUMBS:
                TestUtil.fileContainsString(
                        MessageFormat.format("<</Type/Catalog/Pages 3 0 R/PageMode/UseThumbs/Lang({0})/Metadata 4 0 R>>", docLocaleName),
                        getArtifactsDir() + "PdfSaveOptions.PageMode.pdf");
                break;
            case PdfPageMode.USE_OC:
                TestUtil.fileContainsString(
                        MessageFormat.format("<</Type/Catalog/Pages 3 0 R/PageMode/UseOC/Lang({0})/Metadata 4 0 R>>\r\n", docLocaleName),
                        getArtifactsDir() + "PdfSaveOptions.PageMode.pdf");
                break;
            ...
            case PdfPageMode.USE_ATTACHMENTS:
                TestUtil.fileContainsString(
                        MessageFormat.format("<</Type/Catalog/Pages 3 0 R/PageMode/UseAttachments/Lang({0})/Metadata 4 0 R>>\r\n", docLocaleName),
                        getArtifactsDir() + "PdfSaveOptions.PageMode.pdf");
                break;
        }
        ...
        switch (pageMode) {
            ...
            case PdfPageMode.USE_OC:
                ...
                break;
            case PdfPageMode.USE_ATTACHMENTS:
                Assert.assertEquals(PageMode.UseAttachments, pdfDocument.getPageMode());
                break;
        }
    ...
    public void customPropertiesExport(int pdfCustomPropertiesExportMode) throws Exception {
        ...
        switch (pdfCustomPropertiesExportMode) {
            case PdfCustomPropertiesExport.NONE:
                ...
                Assert.assertEquals(3, pdfDocument.getMetadata().size());
                break;
            case PdfCustomPropertiesExport.METADATA:
                Assert.assertEquals(2, pdfDocument.getInfo().size());
                Assert.assertEquals(4, pdfDocument.getMetadata().size());
    ...
    public void interpolateImages(boolean interpolateImages) throws Exception {
        ...
        {
            TestUtil.fileContainsString("<</Type/XObject/Subtype/Image/Width 400/Height 400/ColorSpace/DeviceGray/BitsPerComponent 8/Length 14 0 R/Filter/FlateDecode>>",
    ...
    public void pdfDigitalSignature() throws Exception {
        ...
        Assert.assertTrue(pdfDocument.getForm().getSignaturesExist());
