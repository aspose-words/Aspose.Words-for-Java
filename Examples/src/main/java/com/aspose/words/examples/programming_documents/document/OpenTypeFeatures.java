...
import com.aspose.words.examples.programming_documents.LinkedTextboxes.WorkingWithLinkedTextboxes;
...
public class OpenTypeFeatures {
	...
	public static void main(String[] args) {
        ...
        doc.getLayoutOptions().setTextShaperFactory(com.aspose.words.Shaping.HarfBuzz.HarfBuzzTextShaperFactory.Instance);
