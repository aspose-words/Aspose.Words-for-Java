...
public class ApplyCustomLogicToEmptyRegions {
	...
	/**
	 * Returns the data used to merge the TestFile document. This dataset
	 * purposely contains only rows for the StoreDetails region and only a
	 * select few for the child region.
	 */
	private static DataSet getDataSource() throws Exception {
		...
		data.getRelations().add(new DataRelation("StoreDetailsToContactDetails", storeDetails, contactDetails, new String[] { "ID" }, new String[] { "ID" }));
