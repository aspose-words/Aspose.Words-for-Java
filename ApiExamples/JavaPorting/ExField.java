...
public class ExField extends ApiExampleBase
{
    ...
    public void getFieldCode() throws Exception
    {
        ...
        Assert.AreEqual(1, doc.getRange().getFields().Count(f => f.Type == FieldType.FieldIf)); //ExSkip
        ...
        Assert.assertEquals($" IF {ControlChar.FieldStartChar} MERGEFIELD NetIncome {ControlChar.FieldSeparatorChar}{ControlChar.FieldEndChar} > 0 \" (surplus of {ControlChar.FieldStartChar} MERGEFIELD  NetIncome \\f $ {ControlChar.FieldSeparatorChar}{ControlChar.FieldEndChar}) \" \"\" ", 
    ...
    public void updateFieldIgnoringMergeFormat() throws Exception
    {
        ...
        FieldIncludePicture includePicture = (FieldIncludePicture)doc.getRange().getFields().First(f => f.Type == FieldType.FieldIncludePicture);
    ...
    public void mergeFieldImages() throws Exception
    {
        ...
        testMergeFieldImages(new Document(getArtifactsDir() + "Field.MERGEFIELD.Images.docx"));
    }
    ...
    public void fieldSet() throws Exception
    {
        ...
        Assert.assertEquals(" SET  MyBookmark \"New text\"", field.getFieldCode());
