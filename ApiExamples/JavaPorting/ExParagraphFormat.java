...
@Test
class ExParagraphFormat !Test class should be public in Java to run, please fix .Net source!  extends ApiExampleBase
{
    @Test
    ...
    public void dropCap(/*DropCapPosition*/int dropCapPosition) throws Exception
    {
        //ExStart
	...
	public static Object[][] dropCapDataProvider() throws Exception
	{
		return new Object[][]
		{
	...
	public static Object[][] paragraphSpacingAutoDataProvider() throws Exception
	{
		return new Object[][]
		{
			{false},
	...
	public static Object[][] paragraphSpacingSameStyleDataProvider() throws Exception
	{
		return new Object[][]
		{
			{false},
	...
	public static Object[][] pageBreakBeforeDataProvider() throws Exception
	{
		return new Object[][]
		{
			{false},
	...
	public static Object[][] widowControlDataProvider() throws Exception
	{
		return new Object[][]
		{
			{false},
