...
/**
 * Corrects JFileChooser Save Dialog behaviour to act more like how Microsoft Word does.
 * - Preserves the current file name in the edit box when a different filter or directory is chosen.
 * - Automatically changes the file extension on the file name when a different filter is chosen.
 */
class SaveDialogChangeListener implements PropertyChangeListener
{
	...
	/**
	 * Restores a file name deleted by JFileChooser when an user changes current directory.
	 */
