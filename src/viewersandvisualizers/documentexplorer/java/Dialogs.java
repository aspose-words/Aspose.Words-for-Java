...
{
	/**
	* Stores the last accessed file path, so that the next file dialog session should start from that directory.
	*/
	private static String mDocumentPath = "";

	/**
	* Stores the name of the currently loaded document. Name is stored without extension to be used when saving in different file format.
	*/
	private static String mDocumentName;

    /**
	* Stores an instance of a file chooser dialog which allows the user to choose a document to open from disk.
	*/

	private static JFileChooser mOpenDialog;
	/**
	* Stores an instance of a file chooser dialog which allows the user to save a document to disk in a given format.
	*/
    ...
    * @return The file name of the selected document or an empty string if the dialog was canceled.
    */
    ...
    /**
    * Opens a chooser dialog and allows the user to pick a path on the disk and format to save a document to.
    * @return The path to save the document to or an empty string if the dialog was canceled.
    */
    ...
    /**
    * Returns the extension of the current file filter selected in the Save As dialog.
    */
